...
export default class Enemy extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y, texture, frame) {
        ...
        this.anims.play('enemy-move-right')
    ...
    preUpdate(t, dt) {
        ...
        switch (this.direction) {
            case 0:
                ...
                this.anims.play('enemy-move-up', true)
                break
            case 1:
                this.setVelocity(0, speed)
                this.anims.play('enemy-move-down', true)
                break
            case 2:
...
Phaser.GameObjects.GameObjectFactory.register('enemy', function (scene, x, y, texture, frame) {
    var sprite = new Enemy(scene, x, y, texture, frame)
